...
------ USAGE TIERING VIEWS
-----------------------------------
DROP VIEW IF EXISTS USER_PROJECT_CURRENT_USAGE_SNAPSHOT CASCADE;
...
SELECT
    ...
    --
    T.PER_MINUTE AS LIMIT_TOKEN_PER_MINUTE,
    T.PER_HOUR AS LIMIT_TOKEN_PER_HOUR,
    T.PER_DAY AS LIMIT_TOKEN_PER_DAY,
    T.PER_MONTH AS LIMIT_TOKEN_PER_MONTH,
    T.PER_YEAR AS LIMIT_TOKEN_PER_YEAR,

    --
    T.COST_PER_MINUTE AS LIMIT_COST_PER_MINUTE,
    T.COST_PER_HOUR AS LIMIT_COST_PER_HOUR,
    T.COST_PER_DAY AS LIMIT_COST_PER_DAY,
    T.COST_PER_MONTH AS LIMIT_COST_PER_MONTH,
    T.COST_PER_YEAR AS LIMIT_COST_PER_YEAR,
...
SELECT
    ...
    PROJECT_ID,
    TIER_ID,
    LIMIT_TOKEN_PER_MINUTE,
    LIMIT_TOKEN_PER_HOUR,
    LIMIT_TOKEN_PER_DAY,
    LIMIT_TOKEN_PER_MONTH,
    LIMIT_TOKEN_PER_YEAR,
    LIMIT_COST_PER_MINUTE,
    LIMIT_COST_PER_HOUR,
    LIMIT_COST_PER_DAY,
    LIMIT_COST_PER_MONTH,
    LIMIT_COST_PER_YEAR,
    CUR_MINUTE_TOTAL_COST,
    CUR_HOUR_TOTAL_COST,
    CUR_DAY_TOTAL_COST,
    CUR_MONTH_TOTAL_COST,
    CUR_YEAR_TOTAL_COST,
    ROUND(100 * CUR_MINUTE_TOTAL_TOKENS / NULLIF(LIMIT_TOKEN_PER_MINUTE, 0), 2) AS PCT_MINUTE_TOKENS_USED,
    ROUND(100 * CUR_HOUR_TOTAL_TOKENS / NULLIF(LIMIT_TOKEN_PER_HOUR, 0), 2) AS PCT_HOUR_TOKENS_USED,
    ROUND(100 * CUR_DAY_TOTAL_TOKENS / NULLIF(LIMIT_TOKEN_PER_DAY, 0), 2) AS PCT_DAY_TOKENS_USED,
    ROUND(100 * CUR_MONTH_TOTAL_TOKENS / NULLIF(LIMIT_TOKEN_PER_MONTH, 0), 2) AS PCT_MONTH_TOKENS_USED,
    ROUND(100 * CUR_YEAR_TOTAL_TOKENS / NULLIF(LIMIT_TOKEN_PER_YEAR, 0), 2) AS PCT_YEAR_TOKENS_USED,
    ROUND(100 * CUR_MINUTE_TOTAL_COST / NULLIF(LIMIT_COST_PER_MINUTE, 0), 2) AS PCT_MINUTE_COST_USED,
    ROUND(100 * CUR_HOUR_TOTAL_COST / NULLIF(LIMIT_COST_PER_HOUR, 0), 2) AS PCT_HOUR_COST_USED,
    ROUND(100 * CUR_DAY_TOTAL_COST / NULLIF(LIMIT_COST_PER_DAY, 0), 2) AS PCT_DAY_COST_USED,
    ROUND(100 * CUR_MONTH_TOTAL_COST / NULLIF(LIMIT_COST_PER_MONTH, 0), 2) AS PCT_MONTH_COST_USED,
    ROUND(100 * CUR_YEAR_TOTAL_COST / NULLIF(LIMIT_COST_PER_YEAR, 0), 2) AS PCT_YEAR_COST_USED
